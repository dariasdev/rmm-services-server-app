...
* application will run on port 8090 by default to change port, run command with parameters. Ex. mvn **spring-boot:run -Dspring-boot.run.arguments=--server.port=8088**
